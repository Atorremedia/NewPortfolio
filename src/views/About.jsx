        ...
        <div className={styles.stackElementsContainer} >
          <div className={styles.stackElement} >
            <div className={styles.stackElementHeading} >
              <img className={styles.stackElementImage} src="url('assets/html5.png" width="25px" alt="HTML5" />
              <h3 className={styles.stackElementName} >HTML5</h3>
            </div>
          </div>
          <div className={styles.stackElement} >
            <div className={styles.stackElementHeading} >
              <img className={styles.stackElementImage} src="url('assets/css3.png" width="50px" alt="CSS3" />
            ...
            <div className={styles.stackSubelementsContainer}>
              <div className={styles.stackSubelement}>
                <img className={styles.stackSubelementImage} src="url('assets/sass.png" width="50px" alt="Sass" />
                <h4 className={styles.stackSubelementName} >Sass</h4>
              </div>
              <div className={styles.stackSubelement}>
                <img className={styles.stackSubelementImage} src="url('assets/tailwind.png" width="50px" alt="Sass" />
                <h4 className={styles.stackSubelementName} >Tailwind</h4>
              </div>
              <div className={styles.stackSubelement}>
                <img className={styles.stackSubelementImage} src="url('assets/bootstraps.png" width="50px" alt="Sass" />
          ...
          <div className={styles.stackElement} >
              <div className={styles.stackElementHeading} >
                <img className={styles.stackElementImage} src="url('assets/js.png" width="50px" alt="Javascript" />
                <h3 className={styles.stackElementName} >Javascript</h3>
              </div>
            <div className={styles.stackSubelementsContainer}>
              <div className={styles.stackSubelement}>
                <img className={styles.stackSubelementImage} src="url('assets/react.png" width="50px" alt="React" />
