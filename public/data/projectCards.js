export default {
  ...
  },
  {
    ...
    text: 'Completely working shopping cart. Implements a functional basket, ready to adapt to any kind of bussiness.',
    linkpath : 'http://shop.augustolle.com',
    github : 'https://github.com/Atorremedia',
    isNew : false,
  ...
  },
  {
    ...
    text: 'This is a web application in Javascript that takes multiple choice questions from an open API (Open Trivia Database) and presents them in a quiz for 1 or 2 players. It features an html form where user can set the game, choosing some options such as number and category of the questions. It shows scores and rates and presents the final winner.',
